...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnMoveWithDataActivity = findViewById(R.id.move_with_data);
        btnMoveWithDataActivity.setOnClickListener(this);
        Button btnDialPhone = findViewById(R.id.dial_number);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.move_with_data :
                ...
                MoveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME,"ini data pindahan");
